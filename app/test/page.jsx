                  ...
                  {projects.map((project, index) => (
                    <SwiperSlide key={index} className="w-full">
                      ...
                      >
                        ...
                        <div className="relative w-full h-full max-w-[98%] max-h-[90%] aspect-video rounded-xl overflow-hidden group/image-container">
                          <Image 
                            alt={project.title} 
                            src={project.image} 
                            fill
